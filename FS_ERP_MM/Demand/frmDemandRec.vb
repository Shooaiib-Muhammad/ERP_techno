Public Class frmDemandRec
    ...
    Private Sub loadIssedData()
        ...
        ElseIf RadioButton6.Checked = True Then  '' by item Name
            ...
            Try
                Me.View_Tran_IN_new_oneTableAdapter.FillBy2(Me.DSDemand.View_Tran_IN_new_one, L4NameComboBox.SelectedValue)
            Catch ex As Exception
        ...
        ElseIf RadioButton7.Checked = True Then  '' By Dept
            ...
            Try
                Me.View_Tran_IN_new_oneTableAdapter.FillBy5(Me.DSDemand.View_Tran_IN_new_one, CustNameComboBox.SelectedValue)
            Catch ex As Exception

            End Try
        ElseIf RadioButton3.Checked = True Then '' By  GD No
            Try
                Me.View_Tran_IN_new_oneTableAdapter.FillBy4(Me.DSDemand.View_Tran_IN_new_one, txtGMNO.Text)
            Catch ex As Exception
        ...
        If e.ColumnIndex = 16 Then
            ...
            If btnMsg = Windows.Forms.DialogResult.Yes Then
                ...
                If ApprovedStatus = True Then
                    Try
                        Tbl_Inv_Tran_InTableAdapter.Insert(DayID.Text, "GDR", Code, Qty, GD, PIID, "", RNO, PPU, CustID, Nothing, 1, UOm, Nothing, DemandQty, Remarks, Narration, IsseddeptID, "Cash")
    ...
    Private Sub View_Tran_INDataGridView_CellEnter(sender As Object, e As DataGridViewCellEventArgs) Handles View_Tran_INDataGridView.CellEnter
        ...
        If e.ColumnIndex = 13 Then
            If Me.View_Tran_INDataGridView.Item(12, e.RowIndex).Value > 0 Then

                Me.View_Tran_INDataGridView.Item(13, e.RowIndex).Value = Val(Me.View_Tran_INDataGridView.Item(6, e.RowIndex).Value) * Val(Me.View_Tran_INDataGridView.Item(12, e.RowIndex).Value)
                If Me.View_Tran_INDataGridView.Item(14, e.RowIndex).Value Is DBNull.Value Then
                    Me.View_Tran_INDataGridView.Item(14, e.RowIndex).Value = Now
    ...
    Private Sub View_Tran_INDataGridView_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles View_Tran_INDataGridView.CellContentClick
        If e.ColumnIndex = 21 Then
            ...
            Dim TransID As Int32 = Me.View_Tran_INDataGridView.Item(20, e.RowIndex).Value
