Public Class frmRptMIRN
    Private Sub btnShowReport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnShowReport.Click
        ...
        If RadioButton1.Checked = True Then
            ...
            Path = "\\server\myreports$\FSERPMM\Inventory\New\RptMRIN.rpt"
        ElseIf RadioButton13.Checked = True Then
            ...
            Path = "\\server\myreports$\FSERPMM\Inventory\New\RptMRINSpecialNote.rpt"
        ...
        ElseIf RadioButton3.Checked Then
            ...
            Path = "\\server\myreports$\FSERPMM\Inventory\New\RptLendedMRIN.rpt"
        ElseIf RadioButton9.Checked Then
            Filter = "{View_Lended_MIRN.DateName}in #" & Format(Me.DateTimePicker1.Value, "MM/dd/yyyy") & "# to #" & Format(Me.DateTimePicker2.Value, "MM/dd/yyyy") & "# "
            Path = "\\server\myreports$\FSERPMM\Inventory\New\RptReturnedMRIN.rpt"
        ...
        ElseIf RadioButton6.Checked Then
            Filter = "{View_Lended_MIRN.DateName}in #" & Format(Me.DateTimePicker1.Value, "MM/dd/yyyy") & "# to #" & Format(Me.DateTimePicker2.Value, "MM/dd/yyyy") & "# "
            Path = "\\server\myreports$\FSERPMM\Inventory\New\RptBorrowedMRIN.rpt"
        ...
        ElseIf RadioButton8.Checked Then
            Filter = "{View_Lended_MIRN.DateName}in #" & Format(Me.DateTimePicker1.Value, "MM/dd/yyyy") & "# to #" & Format(Me.DateTimePicker2.Value, "MM/dd/yyyy") & "# "
            Path = "\\server\myreports$\FSERPMM\Inventory\New\RptLendedMRINSlip.rpt"
        ...
        ElseIf RadioButton15.Checked = True Then
            ...
            Path = "\\server\myreports$\FSERPMM\Inventory\New\RptMRINsp.rpt"
            End If
