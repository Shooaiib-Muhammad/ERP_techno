Public Class frmBladerBillingTran
    ...
    Private Sub LoadRecord()
        Me.View_Bladder_Billing_TransactionTableAdapter.Fill(Me.DSBladderBillingTran.View_Bladder_Billing_Transaction)
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        Dim btnMsg As DialogResult = MessageBox.Show("Are You Sure Want To Generate Punctured Bladders Bill? ", "Message", MessageBoxButtons.YesNo, MessageBoxIcon.Warning, MessageBoxDefaultButton.Button1)
        If btnMsg = Windows.Forms.DialogResult.Yes Then
            ...
            If Me.View_Bladder_BillDataGridView.RowCount > 0 Then
                For i As Integer = 0 To Me.View_Bladder_BillDataGridView.RowCount - 1
                    Me.Tbl_Bladder_Billing_TransactionsTableAdapter.Insert(CInt(Me.View_Bladder_BillDataGridView(0, i).Value), CInt(Me.View_Bladder_BillDataGridView(13, i).Value), CInt(Me.View_Bladder_BillDataGridView(3, i).Value), Me.View_Bladder_BillDataGridView(6, i).Value.ToString, Me.DayNoLabel1.Text, DateRange, CDbl(Me.View_Bladder_BillDataGridView(4, i).Value), CDbl(Me.View_Bladder_BillDataGridView(9, i).Value), CDbl(Me.View_Bladder_BillDataGridView(11, i).Value), CDbl(Me.View_Bladder_BillDataGridView(10, i).Value), CDbl(Me.View_Bladder_BillDataGridView(12, i).Value), Now.Date, False)
                Next
                LoadRecord()
            Else
