Public Class frmCodeProc
    ...
    Private Sub frmCode_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            If frmLoginVer.UserID = 139 Then
                Me.Tbl_Inv_L1TableAdapter.FillBy1(Me.DSCodeProc.tbl_Inv_L1)
                Me.AddL1.Visible = False
                Me.AddL2.Visible = False
                Me.AddL3.Visible = False
                Me.DeleteL1.Visible = False
                Me.DeleteL2.Visible = False
                Me.DeleteL3.Visible = False
                Me.SaveL1.Visible = False
                Me.SaveL2.Visible = False
                Me.SaveL3.Visible = False
            Else
                Me.Tbl_Inv_L1TableAdapter.FillBy(Me.DSCodeProc.tbl_Inv_L1)
                Me.AddL1.Visible = True
                Me.AddL2.Visible = True
                Me.AddL3.Visible = True
                Me.DeleteL1.Visible = True
                Me.DeleteL2.Visible = True
                Me.DeleteL3.Visible = True
                Me.SaveL1.Visible = True
                Me.SaveL2.Visible = True
                Me.SaveL3.Visible = True
            End If
    ...
    Private Sub Tbl_Inv_L4DataGridView_CellEnter(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles Tbl_Inv_L4DataGridView.CellEnter
        If e.ColumnIndex = 3 Then
            ...
            End If
        End If
        If e.ColumnIndex = 7 And Me.Tbl_Inv_L4DataGridView(e.ColumnIndex, e.RowIndex).Value Is DBNull.Value Then

            Dim l4Name As String = Me.Tbl_Inv_L4DataGridView(5, e.RowIndex).Value.ToString
            If l4Name.Length > 0 Then
                ...
                Me.Tbl_Inv_L4DataGridView(14, e.RowIndex).Value = Now.Date
                Me.Tbl_Inv_L4DataGridView(10, e.RowIndex).Value = 0.0
                CheckCode()
            Else
    ...
    Private Sub ToolStripMenuItem2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ToolStripMenuItem2.Click
        Me.Tbl_Inv_L4BindingSource.RemoveFilter()
    End Sub
    Private Sub RemoveFilterToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Me.Tbl_Inv_L4BindingSource.RemoveFilter()
    End Sub
    ...
    Private Sub DeleteL4_Click_1(sender As Object, e As EventArgs) Handles DeleteL4.Click
        Me.Tbl_Inv_L4BindingSource.RemoveCurrent()
    End Sub

    Private Sub DeleteL3_Click(sender As Object, e As EventArgs) Handles DeleteL3.Click
