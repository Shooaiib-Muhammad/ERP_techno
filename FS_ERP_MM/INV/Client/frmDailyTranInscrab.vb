Public Class frmDailyTranInscrab
    Dim Type As String
    Private Sub frmNewTranIn_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        End Try
        If frmLoginVer.UserID = 338 Then
            Me.Tbl_Inv_L4TableAdapter.FillBy1(Me.DSNewTranIn.tbl_Inv_L4)
            Type = "Scrap"
        ElseIf frmLoginVer.DeptID = 24 Then
            Me.Tbl_Inv_L4TableAdapter.FillBy1(Me.DSNewTranIn.tbl_Inv_L4)
            Type = "MAE"
            Try
    ...
    Private Sub loaddata()
        If frmLoginVer.UserID = 338 Then
            Try
                Me.Tbl_Inv_Tran_InTableAdapter.FillBy5(Me.DSNewTranIn.tbl_Inv_Tran_In, Me.DayNoLabel1.Text)
            Catch ex As Exception
