Public Class frmPRRN
    ...
    Private Sub View_Lended_MBindingSource_PositionChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles View_Lended_MBindingSource.PositionChanged
        Try
            Me.View_Lended_DTableAdapter.FillBy(Me.DSPRGP.View_Lended_D, L4NameComboBox.SelectedValue)
    ...
    Private Sub View_Lended_DDataGridView_CellEnter(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles View_Lended_DDataGridView.CellEnter
        If QtyTextBox.TextLength <= 0 Then
            Try
                Dim Id As Integer = Me.View_Lended_DDataGridView(2, e.RowIndex).Value
                TranOutIDLabel2.Text = Id
                ...
                Me.LabelTranOutID.Text = Me.View_Lended_DDataGridView(2, e.RowIndex).Value
    ...
    Private Sub AddIn_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles AddIn.Click
        Try
            ...
            Me.View_Lended_MTableAdapter.FillBy(Me.DSPRGP.View_Lended_M)
        Catch ex As Exception
        End Try
    ...
    Private Sub DeleteIn_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles DeleteIn.Click
        ...
        If btnMsg = Windows.Forms.DialogResult.Yes Then
            Try
                ...
                Me.Tbl_Inv_Tran_InTableAdapter.Fill(Me.DSPRGP.tbl_Inv_Tran_In, Me.DayNoLabel2.Text)
                Me.View_Lended_DTableAdapter.FillBy(Me.DSPRGP.View_Lended_D, Me.L4NameComboBox.SelectedValue)
            Catch ex As Exception
            End Try
        Else
        ...
        If QtyTextBox.TextLength > 0 Then
            If Received + Val(Me.QtyTextBox.Text) <= IssuedQty Then
                Try
                    ...
                    Me.Tbl_Inv_Tran_InTableAdapter.Update(Me.DSPRGP.tbl_Inv_Tran_In)
                    MsgBox("Record Saved")
                    Me.View_Lended_DTableAdapter.FillBy(Me.DSPRGP.View_Lended_D, Me.L4NameComboBox.SelectedValue)
    ...
    Private Sub UndoIn_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles UndoIn.Click
        Try
            Me.View_Lended_MTableAdapter.Fill(Me.DSPRGP.View_Lended_M)
    ...
    End Sub
    Private Sub frmPRRN_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
        ...
        Me.View_Lended_MTableAdapter.Fill(Me.DSPRGP.View_Lended_M)
        Try
            Me.Tbl_Inv_Tran_DateTableAdapter.Fill(Me.DSPRGP.tbl_Inv_Tran_Date, CType(Now.Date, Date))
