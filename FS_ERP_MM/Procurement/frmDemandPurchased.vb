Public Class frmDemandPurchased

    Private Sub frmDemandPurchased_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub Demand_FillBy1()
        Try
            Me.Tbl_Pur_DemandTableAdapter.FillBy16(Me.DSPO.tbl_Pur_Demand, DateTimePicker1.Value.Date, DateTimePicker2.Value.Date)
    ...
    Private Sub Demand_FillBy2()
        If CodeComboBox.SelectedValue <> Nothing Then
            Me.Tbl_Pur_DemandTableAdapter.FillBy17(Me.DSPO.tbl_Pur_Demand, CodeComboBox.SelectedValue)
        End If
    End Sub
    Private Sub Demand_FillBy3()
        If CodeComboBox.SelectedValue <> Nothing Then
            Me.Tbl_Pur_DemandTableAdapter.FillBy18(Me.DSPO.tbl_Pur_Demand, DateTimePicker1.Value.Date, DateTimePicker2.Value.Date, CodeComboBox.SelectedValue)
        End If
    End Sub
    Private Sub Demand_FillBy4()
        If CustNameComboBox.SelectedValue <> Nothing Then
            Me.Tbl_Pur_DemandTableAdapter.FillBy35(Me.DSPO.tbl_Pur_Demand, CustNameComboBox.SelectedValue)
        End If
    End Sub
        ...
        If e.ColumnIndex = 12 And e.RowIndex >= 0 Then
            If Tbl_Pur_DemandDataGridView.Item(12, e.RowIndex).Value Is DBNull.Value Then
                ...
                If dgResult = Windows.Forms.DialogResult.Yes Then
                    ...
                    Me.Tbl_Pur_DemandBindingSource.Filter = "PurchaseStatus is Null"
                End If
            End If
        End If
    ...
    Private Sub GMNO_FillBy41()
        If txtGMNO.TextLength > 0 Then
            Try
                Me.Tbl_Pur_DemandTableAdapter.GMNODemandPurchase_FillBy41(Me.DSPO.tbl_Pur_Demand, txtGMNO.Text)
            Catch ex As Exception
