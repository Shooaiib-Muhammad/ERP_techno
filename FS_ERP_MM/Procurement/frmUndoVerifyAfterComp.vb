Public Class frmUndoVerifyAfterComp
    ...
    Private Sub Demand_FillBy1()
        ...
        ElseIf Status = 4 Then
            Try
                Me.Tbl_Pur_Demand_NewTableAdapter.FillBy15(Me.DSNewProcurement.tbl_Pur_Demand_New, DateTimePicker1.Value.Date, DateTimePicker2.Value.Date)
            Catch ex As Exception
            End Try
        End If
    ...
    Private Sub Demand_FillBy2()
        ...
        ElseIf Status = 4 Then
            Try
                Me.Tbl_Pur_Demand_NewTableAdapter.FillBy16(Me.DSNewProcurement.tbl_Pur_Demand_New, CodeComboBox.SelectedValue)
            Catch ex As Exception
            End Try
        End If
    ...
    Private Sub Demand_FillBy3()
        ...
        ElseIf Status = 4 Then
            If CodeComboBox.SelectedValue <> Nothing Then
                Me.Tbl_Pur_Demand_NewTableAdapter.FillBy18(Me.DSNewProcurement.tbl_Pur_Demand_New, DateTimePicker1.Value.Date, DateTimePicker2.Value.Date, CodeComboBox.SelectedValue)
                SetButton()
            End If
        End If
    ...
    Private Sub Demand_FillBy4()
        ...
        ElseIf Status = 4 Then
            If CustNameComboBox.SelectedValue <> Nothing Then
                Me.Tbl_Pur_Demand_NewTableAdapter.FillBy17(Me.DSNewProcurement.tbl_Pur_Demand_New, CustNameComboBox.SelectedValue)
                SetButton()
            End If
        End If
    ...
    Private Sub GMNO_FillBy41()
        If txtGMNO.TextLength >= 0 Then
            ...
            ElseIf Status = 4 Then
                Try
                    Me.Tbl_Pur_Demand_NewTableAdapter.FillBy19(Me.DSNewProcurement.tbl_Pur_Demand_New, Val(txtGMNO.Text))
                Catch ex As Exception
                End Try
            End If
            SetButton()
    ...
    Private Sub DataGridView3_CellContentClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles DataGridView3.CellContentClick
        ...
        If e.ColumnIndex = 30 And e.RowIndex >= 0 Then
            ...
            If dgResult = Windows.Forms.DialogResult.Yes Then
                ...
                End Try
                Try
                    Me.Tbl_Pur_PartialReceivingTableAdapter.UpdateQuery(Me.Tbl_Pur_DemandDataGridView(0, e.RowIndex).Value)
                Catch ex As Exception
                    MsgBox(ex.Message)
                End Try
                Try
                    Me.Tbl_Pur_DemandTableAdapter.UpdateQuery(Me.Tbl_Pur_DemandDataGridView(0, e.RowIndex).Value)
                Catch ex As Exception
                    MsgBox(ex.Message)
                End Try
                MsgBox("Record Successfully Undo")
                Me.Tbl_Pur_Demand_NewBindingSource.RemoveFilter()
                Me.Tbl_Pur_Demand_NewBindingSource.Filter = "AfterPurchaseVStatus is Null or AfterPurchaseVStatus = 0"
            End If
        End If
    End Sub
