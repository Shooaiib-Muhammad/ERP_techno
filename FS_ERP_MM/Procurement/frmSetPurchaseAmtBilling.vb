Public Class frmSetPurchaseAmtBilling
    ...
    Private Sub SetButton()
        For i As Integer = 0 To Tbl_Pur_DemandDataGridView.RowCount - 1
            If Tbl_Pur_DemandDataGridView.Item(16, i).Value Is DBNull.Value Then
                Tbl_Pur_DemandDataGridView.Item(17, i).ReadOnly = True
                Tbl_Pur_DemandDataGridView.Item(5, i).ReadOnly = False
                Tbl_Pur_DemandDataGridView.Item(9, i).ReadOnly = False
            ...
            Else
                Tbl_Pur_DemandDataGridView.Item(17, i).ReadOnly = False
                Tbl_Pur_DemandDataGridView.Item(5, i).ReadOnly = True
                Tbl_Pur_DemandDataGridView.Item(9, i).ReadOnly = True
    ...
    Private Sub Demand_FillBy1()
        Try
            '       Me.Tbl_Pur_DemandTableAdapter.FillBy22(Me.DSPO.tbl_Pur_Demand, DateTimePicker1.Value.Date, DateTimePicker2.Value.Date)
        Catch ex As Exception
        End Try
        Try
            Me.Tbl_Pur_Demand_BillTableAdapter.Fill(Me.DSPURBILL.tbl_Pur_Demand_Bill, DateTimePicker1.Value.Date, DateTimePicker2.Value.Date)
    ...
    Private Sub Demand_FillBy2()
        If CodeComboBox.SelectedValue <> Nothing Then
            Me.Tbl_Pur_DemandTableAdapter.FillBy23(Me.DSPO.tbl_Pur_Demand, CodeComboBox.SelectedValue)
            SetButton()
        End If
    ...
    Private Sub Demand_FillBy3()
        If CodeComboBox.SelectedValue <> Nothing Then
            Me.Tbl_Pur_DemandTableAdapter.FillBy24(Me.DSPO.tbl_Pur_Demand, DateTimePicker1.Value.Date, DateTimePicker2.Value.Date, CodeComboBox.SelectedValue)
            SetButton()
        End If
    ...
    Private Sub GMNO_FillBy41()
        If txtGMNO.TextLength > 0 Then
            Try
                Me.Tbl_Pur_Demand_BillTableAdapter.FillBy3(Me.DSPURBILL.tbl_Pur_Demand_Bill, txtGMNO.Text)
            Catch ex As Exception
            End Try
            SetButton()
        End If
    ...
    Private Sub Demand_FillBy4()
        If CodeComboBox.SelectedValue <> Nothing Then
            Me.Tbl_Pur_Demand_BillTableAdapter.FillBy2(Me.DSPURBILL.tbl_Pur_Demand_Bill, CustNameComboBox.SelectedValue)
            SetButton()
        End If
    ...
    Private Sub SaveDemand()
        Try
            Me.Validate()
            Me.Tbl_Pur_Demand_BillBindingSource.EndEdit()
            Me.Tbl_Pur_Demand_BillTableAdapter.Update(Me.DSPURBILL.tbl_Pur_Demand_Bill)
        Catch ex As Exception
            MsgBox(ex.Message)
        End Try
    ...
    Private Sub Tbl_Pur_DemandDataGridView_CellContentClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles Tbl_Pur_DemandDataGridView.CellContentClick
        If e.ColumnIndex = 17 And e.RowIndex >= 0 Then
            If Tbl_Pur_DemandDataGridView.Item(17, e.RowIndex).ReadOnly = False Then
        ...
        If Tbl_Pur_DemandDataGridView.Item(16, e.RowIndex).Value Is DBNull.Value Then
            If e.ColumnIndex = 10 Then
                If Tbl_Pur_DemandDataGridView.Item(10, e.RowIndex).Value Is DBNull.Value Then
                    If Tbl_Pur_DemandDataGridView.Item(14, e.RowIndex).Value IsNot DBNull.Value And Tbl_Pur_DemandDataGridView.Item(9, e.RowIndex).Value IsNot DBNull.Value Then
                        Tbl_Pur_DemandDataGridView.Item(10, e.RowIndex).Value = Tbl_Pur_DemandDataGridView.Item(14, e.RowIndex).Value * Tbl_Pur_DemandDataGridView.Item(9, e.RowIndex).Value
                    End If
                End If
            ElseIf e.ColumnIndex = 11 Then
                If Tbl_Pur_DemandDataGridView.Item(11, e.RowIndex).Value Is DBNull.Value Then
                    If Tbl_Pur_DemandDataGridView.Item(10, e.RowIndex).Value IsNot DBNull.Value Then
                        Tbl_Pur_DemandDataGridView.Item(11, e.RowIndex).Value = Now.Date
                    End If
                End If
            ElseIf e.ColumnIndex = 12 Then
                If Tbl_Pur_DemandDataGridView.Item(12, e.RowIndex).Value Is DBNull.Value Then
                    If Tbl_Pur_DemandDataGridView.Item(10, e.RowIndex).Value IsNot DBNull.Value Then
                        Tbl_Pur_DemandDataGridView.Item(12, e.RowIndex).Value = "Cash"
                    End If
                End If
            End If
        End If
