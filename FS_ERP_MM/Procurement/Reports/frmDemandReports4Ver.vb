Public Class frmDemandReports4Ver
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        If RadioButton1.Checked Then 'For Pending Demands
            If RadioButton4.Checked Then
                Path = "" & frmLoginVer.Reportpath & "\rptGenDemandsDt.rpt"
            ...
            ElseIf RadioButton11.Checked Then
                Path = "" & frmLoginVer.Reportpath & "\rptGenDemandsMn.rpt"
        ...
        ElseIf RadioButton8.Checked Then 'For Full Received Demands
            If RadioButton4.Checked Then
                Path = "" & frmLoginVer.Reportpath & "\rptRecDemandsDt.rpt"
            ...
            ElseIf RadioButton11.Checked Then
                Path = "" & frmLoginVer.Reportpath & "\rptRecDemandsMn.rpt"
        ...
        ElseIf RadioButton16.Checked Then 'For Issuance Demands
            Path = "" & frmLoginVer.Reportpath & "\rptIssueDemandsDt.rpt"
            If RadioButton4.Checked Then
                'Path = "\\server\MyReports$\FSERPMM\Procurement\OtherMaterial\rptIssueDemandsDt.rpt"
                Filter = "{View_Rpt_Pur_GenDemands.IssuanceStatus} And {View_Rpt_Pur_GenDemands.IssueDate} in Datetime(" & DateTimePicker1.Value.Year & "," & DateTimePicker1.Value.Month & "," & DateTimePicker1.Value.Day & ") to Datetime(" & DateTimePicker2.Value.Year & "," & DateTimePicker2.Value.Month & "," & DateTimePicker2.Value.Day & ")"
            ElseIf RadioButton5.Checked Then
                'Path = "\\server\MyReports$\FSERPMM\Procurement\OtherMaterial\rptRecDemandsDt.rpt"
                Filter = "{View_Rpt_Pur_GenDemands.IssuanceStatus} And {View_Rpt_Pur_GenDemands.IssueDate} in Datetime(" & DateTimePicker1.Value.Year & "," & DateTimePicker1.Value.Month & "," & DateTimePicker1.Value.Day & ") to Datetime(" & DateTimePicker2.Value.Year & "," & DateTimePicker2.Value.Month & "," & DateTimePicker2.Value.Day & ") And {View_Rpt_Pur_GenDemands.Code} = '" & L4NameComboBox.SelectedValue & "'"
            ElseIf RadioButton6.Checked Then
                'Path = "\\server\MyReports$\FSERPMM\Procurement\OtherMaterial\rptRecDemandsDt.rpt"
                Filter = "{View_Rpt_Pur_GenDemands.IssuanceStatus} And {View_Rpt_Pur_GenDemands.IssueDate} in Datetime(" & DateTimePicker1.Value.Year & "," & DateTimePicker1.Value.Month & "," & DateTimePicker1.Value.Day & ") to Datetime(" & DateTimePicker2.Value.Year & "," & DateTimePicker2.Value.Month & "," & DateTimePicker2.Value.Day & ") And {View_Rpt_Pur_GenDemands.LocalCustID} = " & CustNameComboBox.SelectedValue
            ElseIf RadioButton17.Checked Then
                'Path = "\\server\MyReports$\FSERPMM\Procurement\OtherMaterial\rptRecDemandsDt.rpt"
            ...
            ElseIf RadioButton10.Checked Then
                'Path = "\\server\MyReports$\FSERPMM\Procurement\OtherMaterial\rptRecDemandsDt.rpt"
                Filter = "{View_Rpt_Pur_GenDemands.IssuanceStatus} And {View_Rpt_Pur_GenDemands.IssueDate} in Datetime(" & DateTimePicker1.Value.Year & "," & DateTimePicker1.Value.Month & "," & DateTimePicker1.Value.Day & ") to Datetime(" & DateTimePicker2.Value.Year & "," & DateTimePicker2.Value.Month & "," & DateTimePicker2.Value.Day & ") And {View_Rpt_Pur_GenDemands.GMNo} = " & GMNoComboBox.SelectedValue
            ElseIf RadioButton11.Checked Then
                'Path = "\\server\MyReports$\FSERPMM\Procurement\OtherMaterial\rptRecDemandsMnIssuance.rpt"
                Filter = "{@MyYear} = " & DateTimePicker1.Value.Year & " And {@MyMonth} = " & DateTimePicker1.Value.Month & " And not {View_Rpt_Pur_GenDemands.IssuanceStatus}"
            ElseIf RadioButton12.Checked Then
                'Path = "\\server\MyReports$\FSERPMM\Procurement\OtherMaterial\rptRecDemandsMnIssuance.rpt"
                Filter = "{@MyYear} = " & DateTimePicker1.Value.Year & " And {@MyMonth} = " & DateTimePicker1.Value.Month & " And {View_Rpt_Pur_GenDemands.IssuanceStatus}"
            ElseIf RadioButton13.Checked Then
                'Path = "\\server\MyReports$\FSERPMM\Procurement\OtherMaterial\rptIssuedDemandsMn.rpt"
                Filter = "{View_Rpt_Pur_GenDemands.IssuanceStatus} And {@MyYear} = " & DateTimePicker1.Value.Year & " And {@MyMonth} = " & DateTimePicker1.Value.Month & " And {View_Rpt_Pur_GenDemands.LocalCustID} = " & CustNameComboBox.SelectedValue
            ElseIf RadioButton9.Checked Then
                'Path = "\\server\MyReports$\FSERPMM\Procurement\OtherMaterial\rptIssuedDemandsMn.rpt"
                Filter = "{View_Rpt_Pur_GenDemands.IssuanceStatus} And {@MyYear} = " & DateTimePicker1.Value.Year & " And {@MyMonth} = " & DateTimePicker1.Value.Month & " And {View_Rpt_Pur_GenDemands.GMNo} = " & GMNoComboBox.SelectedValue
            End If
            'End here
        ...
        ElseIf RadioButton15.Checked Then 'For Approved Demands Before Process
            'Path = "\\server\MyReports$\FSERPMM\Procurement\OtherMaterial\rptGenDemandsDt.rpt"
            'Filter = "{View_Rpt_Pur_GenDemands.DemandStatus} = 'Active' And {View_Rpt_Pur_GenDemands.VerificationStatus}"

            If RadioButton4.Checked Then
                Path = "" & frmLoginVer.Reportpath & "\rptGenDemandsDt.rpt"
                Filter = "{View_Rpt_Pur_GenDemands.VerificationStatus} And {View_Rpt_Pur_GenDemands.PDDate} in Datetime(" & DateTimePicker1.Value.Year & "," & DateTimePicker1.Value.Month & "," & DateTimePicker1.Value.Day & ") to Datetime(" & DateTimePicker2.Value.Year & "," & DateTimePicker2.Value.Month & "," & DateTimePicker2.Value.Day & ")"
            ElseIf RadioButton5.Checked Then
                Path = "" & frmLoginVer.Reportpath & "\rptGenDemandsDt.rpt"
                Filter = "{View_Rpt_Pur_GenDemands.VerificationStatus} And {View_Rpt_Pur_GenDemands.PDDate} in Datetime(" & DateTimePicker1.Value.Year & "," & DateTimePicker1.Value.Month & "," & DateTimePicker1.Value.Day & ") to Datetime(" & DateTimePicker2.Value.Year & "," & DateTimePicker2.Value.Month & "," & DateTimePicker2.Value.Day & ") And {View_Rpt_Pur_GenDemands.Code} = '" & L4NameComboBox.SelectedValue & "'"
            ElseIf RadioButton6.Checked Then
            ...
            ElseIf RadioButton11.Checked Then
                Path = "" & frmLoginVer.Reportpath & "\rptGenDemandsMn.rpt"
                Filter = "{View_Rpt_Pur_GenDemands.VerificationStatus} And {@MyYear} = " & DateTimePicker1.Value.Year & " And {@MyMonth} = " & DateTimePicker1.Value.Month
            ElseIf RadioButton12.Checked Then
                Path = "" & frmLoginVer.Reportpath & "\rptGenDemandsMn.rpt"
                Filter = "{View_Rpt_Pur_GenDemands.VerificationStatus} And {@MyYear} = " & DateTimePicker1.Value.Year & " And {@MyMonth} = " & DateTimePicker1.Value.Month & " And {View_Rpt_Pur_GenDemands.Code} = '" & L4NameComboBox.SelectedValue & "'"
            ElseIf RadioButton13.Checked Then
                Path = "" & frmLoginVer.Reportpath & "\rptGenDemandsMn.rpt"
                Filter = "{View_Rpt_Pur_GenDemands.VerificationStatus} And {@MyYear} = " & DateTimePicker1.Value.Year & " And {@MyMonth} = " & DateTimePicker1.Value.Month & " And {View_Rpt_Pur_GenDemands.LocalCustID} = " & CustNameComboBox.SelectedValue
            ElseIf RadioButton9.Checked Then
                Path = "" & frmLoginVer.Reportpath & "\rptGenDemandsMn.rpt"
                Filter = "{View_Rpt_Pur_GenDemands.VerificationStatus} And {@MyYear} = " & DateTimePicker1.Value.Year & " And {@MyMonth} = " & DateTimePicker1.Value.Month & " And {View_Rpt_Pur_GenDemands.GMNo} = " & GMNoComboBox.SelectedValue
            End If
        ElseIf RadioButton18.Checked Then 'For Approved Demands Before Process
            Path = "\\server\MyReports$\FSERPMM\Procurement\RptPendingMaterialDemands.rpt"
            Filter = "{View_PUR_Pending_Issuance.CompDate} in Datetime(" & DateTimePicker1.Value.Year & "," & DateTimePicker1.Value.Month & "," & DateTimePicker1.Value.Day & ") to Datetime(" & DateTimePicker2.Value.Year & "," & DateTimePicker2.Value.Month & "," & DateTimePicker2.Value.Day & ")"
        End If
    ...
    Private Sub frmDemandReports4Ver_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.Tbl_Pur_Demand_Head1TableAdapter.FillBy(Me.DSPO.tbl_Pur_Demand_Head1)
        Me.Tbl_Pur_Demand_HeadTableAdapter.FillBy(Me.DSPO.tbl_Pur_Demand_Head)
    ...
    Private Sub EnableDisabel(ByVal L5Status As Boolean, ByVal DT1Status As Boolean, ByVal L6Status As Boolean, ByVal DT2Status As Boolean, ByVal L8Status As Boolean, ByVal CMB1Status As Boolean, ByVal L10Status As Boolean, ByVal CMB2Status As Boolean, ByVal L2Status As Boolean, ByVal CMB3Status As Boolean)
        ...
        GMNoComboBox1.Enabled = CMB3Status
        Label9.Enabled = L2Status
    End Sub
