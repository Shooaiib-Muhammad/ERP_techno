Public Class frmDemandReports4Ver1
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        Dim Filter As String = ""
        Dim Path As String = ""
        Dim objRptViewer As New Class_Utility
        If RadioButton20.Checked = True Then
            Path = "\\server\MyReports$\FSERPMM\Procurement\Rpt_Audit_Approval.rpt"
            Filter = "{VIew_Audit_Blling_Verfication.AuditVerDate}  in #" & Format(Me.DateTimePicker1.Value, "MM/dd/yyyy") & "# to #" & Format(Me.DateTimePicker2.Value, "MM/dd/yyyy") & "#"


        ElseIf RadioButton1.Checked Then 'For Pending Demands
        ...
        ElseIf RadioButton16.Checked Then 'For Issuance Demands
            ...
            ElseIf RadioButton12.Checked Then
                'Path = "\\server\MyReports$\FSERPMM\Procurement\OtherMaterial\rptRecDemandsMnIssuance.rpt"
                Filter = "{View_Rpt_Pur_GenDemands.Code}  = '" & L4NameComboBox.SelectedValue & "' And {@MyYear} = " & DateTimePicker1.Value.Year & " And {@MyMonth} = " & DateTimePicker1.Value.Month & " And {View_Rpt_Pur_GenDemands.IssuanceStatus}"
            ElseIf RadioButton13.Checked Then
