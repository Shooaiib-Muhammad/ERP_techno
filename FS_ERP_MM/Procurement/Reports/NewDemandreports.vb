Public Class NewDemandreports
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        If RadioButton26.Checked = True Then
            Path = "\\server\MyReports$\FSERPPC\Security\Rpt_Inv_Receive.rpt"
            ...
            ElseIf RadioButton15.Checked Then
                Filter = " {View_Inv_Receive_Qty.GMNO} in " & GMNoComboBox.SelectedValue & " to " & GMNoComboBox1.SelectedValue & ""
            ElseIf RadioButton12.Checked Then
                Filter = " {View_Inv_Receive_Qty.GMNO} = " & GMNoComboBox.SelectedValue & "  And {View_Inv_Receive_Qty.DateName} In #" & Format(Me.DateTimePicker1.Value, "MM/dd/yyyy") & "# To #" & Format(Me.DateTimePicker2.Value, "MM/dd/yyyy") & "#"
        ...
        ElseIf RadioButton1.Checked Then
            ...
            ElseIf RadioButton6.Checked Then
                Filter = " {View_Active_Demands.DemandStatus} = 'Active' And {View_Active_Demands.Balance} > 0.00 And {View_Active_Demands.VerificationStatus} And {View_Active_Demands.VerificationDate1} in Datetime(" & DateTimePicker1.Value.Year & "," & DateTimePicker1.Value.Month & "," & DateTimePicker1.Value.Day & ") to Datetime(" & DateTimePicker2.Value.Year & "," & DateTimePicker2.Value.Month & "," & DateTimePicker2.Value.Day & ") And {View_Active_Demands.Code} = '" & L4NameComboBox.SelectedValue & "' And {View_Active_Demands.Balance} > 0.00"
            ElseIf RadioButton7.Checked Then
                Filter = " {View_Active_Demands.DemandStatus} = 'Active' And  {View_Active_Demands.Balance} > 0.00 And {View_Active_Demands.VerificationStatus} And{View_Active_Demands.VerificationDate1} in Datetime(" & DateTimePicker1.Value.Year & "," & DateTimePicker1.Value.Month & "," & DateTimePicker1.Value.Day & ") to Datetime(" & DateTimePicker2.Value.Year & "," & DateTimePicker2.Value.Month & "," & DateTimePicker2.Value.Day & ") And {View_Active_Demands.LocalCustID} = " & CustNameComboBox.SelectedValue
            ElseIf RadioButton12.Checked Then
        ...
        ElseIf RadioButton25.Checked Then
            ...
            If RadioButton5.Checked Then
                ...
                'Filter = "{View_Rpt_Pur_GenDemands.VerificationDate} in Datetime(" & DateTimePicker1.Value.Year & "," & DateTimePicker1.Value.Month & "," & DateTimePicker1.Value.Day & ") to Datetime(" & DateTimePicker2.Value.Year & "," & DateTimePicker2.Value.Month & "," & DateTimePicker2.Value.Day & ")"
            ElseIf RadioButton6.Checked Then
                Filter = "{View_Rpt_Pur_GenDemands.DemandStatus} = 'Active' And {View_Rpt_Pur_GenDemands.Balance} > 0.00 And {View_Rpt_Pur_GenDemands.VerificationStatus} And {View_Rpt_Pur_GenDemands.VerificationDate1} in Datetime(" & DateTimePicker1.Value.Year & "," & DateTimePicker1.Value.Month & "," & DateTimePicker1.Value.Day & ") to Datetime(" & DateTimePicker2.Value.Year & "," & DateTimePicker2.Value.Month & "," & DateTimePicker2.Value.Day & ") And {View_Rpt_Pur_GenDemands.Code} = '" & L4NameComboBox.SelectedValue & "' And {View_Rpt_Pur_GenDemands.ReceiveQty} > 0.00 And {View_Rpt_Pur_GenDemands.Balance} > 0.00"
            ElseIf RadioButton7.Checked Then
                Filter = "{View_Rpt_Pur_GenDemands.DemandStatus} = 'Active' And {View_Rpt_Pur_GenDemands.ReceiveQty} > 0.00 And {View_Rpt_Pur_GenDemands.Balance} > 0.00 And {View_Rpt_Pur_GenDemands.VerificationStatus}  And {View_Rpt_Pur_GenDemands.VerificationDate1} in Datetime(" & DateTimePicker1.Value.Year & "," & DateTimePicker1.Value.Month & "," & DateTimePicker1.Value.Day & ") to Datetime(" & DateTimePicker2.Value.Year & "," & DateTimePicker2.Value.Month & "," & DateTimePicker2.Value.Day & ") And {View_Rpt_Pur_GenDemands.LocalCustID} = " & CustNameComboBox.SelectedValue
            ElseIf RadioButton12.Checked Then
        ...
        ElseIf RadioButton4.Checked Then
            ...
            ElseIf RadioButton6.Checked Then
                Filter = "Isnull({View_Rpt_Pur_GenDemands.PartialRecStatus})  And {View_Rpt_Pur_GenDemands.CompDate} in Datetime(" & DateTimePicker1.Value.Year & "," & DateTimePicker1.Value.Month & "," & DateTimePicker1.Value.Day & ") to Datetime(" & DateTimePicker2.Value.Year & "," & DateTimePicker2.Value.Month & "," & DateTimePicker2.Value.Day & ") And {View_Rpt_Pur_GenDemands.Code} = '" & L4NameComboBox.SelectedValue & "'"
            ElseIf RadioButton7.Checked Then
                Filter = "Isnull({View_Rpt_Pur_GenDemands.PartialRecStatus})  And {View_Rpt_Pur_GenDemands.CompDate} in Datetime(" & DateTimePicker1.Value.Year & "," & DateTimePicker1.Value.Month & "," & DateTimePicker1.Value.Day & ") to Datetime(" & DateTimePicker2.Value.Year & "," & DateTimePicker2.Value.Month & "," & DateTimePicker2.Value.Day & ") And {View_Rpt_Pur_GenDemands.LocalCustID} = " & CustNameComboBox.SelectedValue
            ElseIf RadioButton12.Checked Then
                Filter = "Isnull({View_Rpt_Pur_GenDemands.PartialRecStatus})  And {View_Rpt_Pur_GenDemands.CompDate} in Datetime(" & DateTimePicker1.Value.Year & "," & DateTimePicker1.Value.Month & "," & DateTimePicker1.Value.Day & ") to Datetime(" & DateTimePicker2.Value.Year & "," & DateTimePicker2.Value.Month & "," & DateTimePicker2.Value.Day & ") And {View_Rpt_Pur_GenDemands.GMNo} in " & GMNoComboBox.SelectedValue & " to " & GMNoComboBox1.SelectedValue
            End If
        ...
        ElseIf RadioButton10.Checked Then
            ...
            ElseIf RadioButton6.Checked Then
                Filter = "{View_Rpt_Pur_GenDemands.CompDate1} in Datetime(" & DateTimePicker1.Value.Year & "," & DateTimePicker1.Value.Month & "," & DateTimePicker1.Value.Day & ") to Datetime(" & DateTimePicker2.Value.Year & "," & DateTimePicker2.Value.Month & "," & DateTimePicker2.Value.Day & ") And {View_Rpt_Pur_GenDemands.Code} = '" & L4NameComboBox.SelectedValue & "' "
            ElseIf RadioButton7.Checked Then
                Filter = "{View_Rpt_Pur_GenDemands.CompDate1} in Datetime(" & DateTimePicker1.Value.Year & "," & DateTimePicker1.Value.Month & "," & DateTimePicker1.Value.Day & ") to Datetime(" & DateTimePicker2.Value.Year & "," & DateTimePicker2.Value.Month & "," & DateTimePicker2.Value.Day & ") And {View_Rpt_Pur_GenDemands.LocalCustID} = " & CustNameComboBox.SelectedValue & " "
            ElseIf RadioButton12.Checked Then
                Filter = "{View_Rpt_Pur_GenDemands.CompDate1} in Datetime(" & DateTimePicker1.Value.Year & "," & DateTimePicker1.Value.Month & "," & DateTimePicker1.Value.Day & ") to Datetime(" & DateTimePicker2.Value.Year & "," & DateTimePicker2.Value.Month & "," & DateTimePicker2.Value.Day & ") And {View_Rpt_Pur_GenDemands.GMNo} in " & GMNoComboBox.SelectedValue & " to " & GMNoComboBox1.SelectedValue & " "
            End If
        ...
        ElseIf RadioButton16.Checked Then
            ...
            If RadioButton5.Checked Then   'For Non POs Only
                If TextBox1.Text = "" Then
                    Filter = "{View_Rpt_Pur_PartialFullUnion.PurchaseDescription} = '" & Me.ComboBox1.Text & "' And {View_Rpt_Pur_PartialFullUnion.AmtEntryDate} in #" & Format(Me.DateTimePicker1.Value, "MM/dd/yyyy") & "# to #" & Format(Me.DateTimePicker2.Value, "MM/dd/yyyy") & "# "
                Else
                    Filter = "{View_Rpt_Pur_PartialFullUnion.BillNo}='" & Me.TextBox1.Text & "' And {View_Rpt_Pur_PartialFullUnion.PurchaseDescription} = '" & Me.ComboBox1.Text & "' And  {View_Rpt_Pur_PartialFullUnion.PurchaseStatus} =  true And {View_Rpt_Pur_PartialFullUnion.AmtEntryDate} in #" & Format(Me.DateTimePicker1.Value, "MM/dd/yyyy") & "# to #" & Format(Me.DateTimePicker2.Value, "MM/dd/yyyy") & "#"
                End If

            ElseIf RadioButton6.Checked Then
                Filter = "{View_Rpt_Pur_PartialFullUnion.PurchaseDescription} = '" & Me.ComboBox1.Text & "' And    {View_Rpt_Pur_PartialFullUnion.AmtEntryDate} in #" & Format(Me.DateTimePicker1.Value, "MM/dd/yyyy") & "# to #" & Format(Me.DateTimePicker2.Value, "MM/dd/yyyy") & "#  And {View_Rpt_Pur_PartialFullUnion.Code} = '" & L4NameComboBox.SelectedValue & "'"
            ElseIf RadioButton7.Checked Then   'For Non POs Only
                Filter = "{View_Rpt_Pur_PartialFullUnion.PurchaseDescription} = '" & Me.ComboBox1.Text & "' And    {View_Rpt_Pur_PartialFullUnion.AmtEntryDate} in #" & Format(Me.DateTimePicker1.Value, "MM/dd/yyyy") & "# to #" & Format(Me.DateTimePicker2.Value, "MM/dd/yyyy") & "# And {View_Rpt_Pur_PartialFullUnion.LocalCustID} = " & CustNameComboBox.SelectedValue & ""
            ElseIf RadioButton8.Checked Then
                Filter = "{View_Rpt_Pur_PartialFullUnion.PurchaseDescription}= '" & Me.ComboBox1.Text & "' And    {View_Rpt_Pur_PartialFullUnion.AmtEntryDate} in #" & Format(Me.DateTimePicker1.Value, "MM/dd/yyyy") & "# to #" & Format(Me.DateTimePicker2.Value, "MM/dd/yyyy") & "#"
            ElseIf RadioButton12.Checked Then
                Filter = "{View_Rpt_Pur_PartialFullUnion.PurchaseDescription} = '" & Me.ComboBox1.Text & "' And  {View_Rpt_Pur_PartialFullUnion.AmtEntryDate} in #" & Format(Me.DateTimePicker1.Value, "MM/dd/yyyy") & "# to #" & Format(Me.DateTimePicker2.Value, "MM/dd/yyyy") & "# And {View_Rpt_Pur_PartialFullUnion.GMNo} in " & GMNoComboBox.SelectedValue & " to " & GMNoComboBox1.SelectedValue & ""

            ElseIf RadioButton15.Checked Then

                Filter = "{View_Rpt_Pur_PartialFullUnion.PurchaseDescription} = '" & Me.ComboBox1.Text & "'  And  {View_Rpt_Pur_PartialFullUnion.GMNo} in " & GMNoComboBox.SelectedValue & " to " & GMNoComboBox1.SelectedValue
            ElseIf RadioButton24.Checked Then '' vendor name
            ...
            ElseIf RadioButton18.Checked Then '' vendor name

                Filter = "{View_Rpt_Pur_PartialFullUnion.VendorName} = '" & Me.VendorNameComboBox.Text & "'  And  {View_Rpt_Pur_PartialFullUnion.AmtEntryDate} in #" & Format(Me.DateTimePicker1.Value, "MM/dd/yyyy") & "# to #" & Format(Me.DateTimePicker2.Value, "MM/dd/yyyy") & "# "

            ElseIf RadioButton20.Checked Then '' vendor name pending

                Filter = "{View_Rpt_Pur_PartialFullUnion.VendorName} = ""  And  {View_Rpt_Pur_PartialFullUnion.AmtEntryDate} in #" & Format(Me.DateTimePicker1.Value, "MM/dd/yyyy") & "# to #" & Format(Me.DateTimePicker2.Value, "MM/dd/yyyy") & "# "
        ...
        ElseIf RadioButton13.Checked Then
            ...
            ElseIf RadioButton5.Checked Then
                Filter = "{View_Rpt_Pur_GenDemands.VerificationStatus} = True  And {tbl_Pur_PartialReceiving.PatialRecDate} in Datetime(" & DateTimePicker1.Value.Year & "," & DateTimePicker1.Value.Month & "," & DateTimePicker1.Value.Day & ") to Datetime(" & DateTimePicker2.Value.Year & "," & DateTimePicker2.Value.Month & "," & DateTimePicker2.Value.Day & ")"
            ElseIf RadioButton7.Checked Then
                Filter = "{View_Rpt_Pur_GenDemands.VerificationStatus} = True And {tbl_Pur_PartialReceiving.PatialRecDate} in Datetime(" & DateTimePicker1.Value.Year & "," & DateTimePicker1.Value.Month & "," & DateTimePicker1.Value.Day & ") to Datetime(" & DateTimePicker2.Value.Year & "," & DateTimePicker2.Value.Month & "," & DateTimePicker2.Value.Day & ") And {View_Rpt_Pur_GenDemands.LocalCustID} = " & CustNameComboBox.SelectedValue
            ElseIf RadioButton12.Checked Then
                Filter = "{View_Rpt_Pur_GenDemands.VerificationStatus} = True And {tbl_Pur_PartialReceiving.PatialRecDate} in Datetime(" & DateTimePicker1.Value.Year & "," & DateTimePicker1.Value.Month & "," & DateTimePicker1.Value.Day & ") to Datetime(" & DateTimePicker2.Value.Year & "," & DateTimePicker2.Value.Month & "," & DateTimePicker2.Value.Day & ") And {View_Rpt_Pur_GenDemands.GMNo} in " & GMNoComboBox.SelectedValue & " to " & GMNoComboBox1.SelectedValue
            ElseIf RadioButton15.Checked Then
        ...
        ElseIf RadioButton3.Checked Then
            'Path = "\\server\myreports$\FSERPMM\NewProcuments\OtherMaterial\rptPendingDemandsDt.rpt"
            'If RadioButton5.Checked Then
        ...
        ElseIf RadioButton17.Checked Then
            'Path = "\\server\myreports$\FSERPMM\NewProcuments\OtherMaterial\rptOGDemandsDt.rpt"
            'If RadioButton5.Checked Then
        ...
        ElseIf RadioButton23.Checked Then
            Path = "\\server\myreports$\FSERPMM\NewProcuments\RptVendorInfo.rpt"
