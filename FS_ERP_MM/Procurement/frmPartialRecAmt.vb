Public Class frmPartialRecAmt
    ...
    Private Sub PartialAmtTextBox_TextChanged(sender As Object, e As EventArgs) Handles PartialAmtTextBox.TextChanged

    End Sub

    Private Sub PartialUnitPriceTextBox_TextChanged(sender As Object, e As EventArgs) Handles PartialUnitPriceTextBox.TextChanged
        If Val(PartialUnitPriceTextBox.Text) > 0 Then
            PartialAmtTextBox.Text = Val(PartialQtyTextBox.Text) * Val(PartialUnitPriceTextBox.Text)

        End If
    End Sub

    Private Sub frmPartialRecAmt_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
