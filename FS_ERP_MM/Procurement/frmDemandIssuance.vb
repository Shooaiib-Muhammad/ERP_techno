Public Class frmDemandIssuance
    ...
    Private Sub Tbl_Pur_DemandBindingNavigatorSaveItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Tbl_Pur_DemandBindingNavigatorSaveItem.Click
        Try
            ...
            Me.Tbl_Pur_DemandTableAdapter.Update(Me.DSDemandIssuance.tbl_Pur_Demand)
            ShowData()
    ...
    Private Sub frmDemandIssuance_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        'TODO: This line of code loads data into the 'DSDemandIssuance.tbl_Pur_Demand' table. You can move, or remove it, as needed.
        ShowData()
    ...
    Private Sub ShowData()
        Try
            If RadioButton1.Checked Then
                Me.Tbl_Pur_DemandTableAdapter.FillBy(Me.DSDemandIssuance.tbl_Pur_Demand, Me.DateTimePicker1.Text, Me.DateTimePicker2.Text)
            ElseIf RadioButton2.Checked Then
                Me.Tbl_Pur_DemandTableAdapter.FillBy2(Me.DSDemandIssuance.tbl_Pur_Demand, Me.CodeComboBox.SelectedValue)
            ElseIf RadioButton3.Checked Then
                Me.Tbl_Pur_DemandTableAdapter.FillBy3(Me.DSDemandIssuance.tbl_Pur_Demand, Me.DateTimePicker1.Text, Me.DateTimePicker2.Text, Me.CodeComboBox.SelectedValue)
            ElseIf RadioButton4.Checked Then
                Me.Tbl_Pur_DemandTableAdapter.FillBy1(Me.DSDemandIssuance.tbl_Pur_Demand, CustNameComboBox.SelectedValue)
            ElseIf RadioButton5.Checked Then
                Me.Tbl_Pur_DemandTableAdapter.Fill(Me.DSDemandIssuance.tbl_Pur_Demand, Me.txtGMNO.Text)
            End If
        Catch ex As Exception
        End Try
    End Sub
