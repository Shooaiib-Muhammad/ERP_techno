Public Class frmNewProcDemandExceptPO

    Private Sub frmProcDemandExceptPO_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub frmProcDemandExceptPO_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        'TODO: This line of code loads data into the 'DSPO.tbl_Pur_Demand_Periority' table. You can move, or remove it, as needed.
    ...
    Private Sub Demand_FillBy1()
        Try
            Me.Tbl_Pur_DemandTableAdapter.FillBy4(Me.DSPO.tbl_Pur_Demand, DateTimePicker1.Value.Date, DateTimePicker2.Value.Date)
    ...
    Private Sub Demand_FillBy2()
        If CodeComboBox.SelectedValue <> Nothing Then
            Me.Tbl_Pur_DemandTableAdapter.FillBy5(Me.DSPO.tbl_Pur_Demand, CodeComboBox.SelectedValue)
        End If
    End Sub

    Private Sub Demand_FillBy3()
        If CodeComboBox.SelectedValue <> Nothing Then
            Me.Tbl_Pur_DemandTableAdapter.FillBy6(Me.DSPO.tbl_Pur_Demand, DateTimePicker1.Value.Date, DateTimePicker2.Value.Date, CodeComboBox.SelectedValue)
        End If
    End Sub

    Private Sub Demand_FillBy4()
        If CustNameComboBox.SelectedValue <> Nothing Then
            Me.Tbl_Pur_DemandTableAdapter.FillBy36(Me.DSPO.tbl_Pur_Demand, CustNameComboBox.SelectedValue)
        End If
    End Sub
    ...
    Private Sub Tbl_Pur_DemandDataGridView_CellEndEdit(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles Tbl_Pur_DemandDataGridView.CellEndEdit
    ...
    Private Sub Tbl_Pur_DemandDataGridView_CellEnter(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles Tbl_Pur_DemandDataGridView.CellEnter
        If e.ColumnIndex = 14 Then
            If Me.Tbl_Pur_DemandDataGridView(14, e.RowIndex).Value Is DBNull.Value Then
                ...
                btnMsg = MessageBox.Show("Are You Sure Want To Status On? ", "Message", MessageBoxButtons.YesNo, MessageBoxIcon.Warning, MessageBoxDefaultButton.Button1)
                If btnMsg = Windows.Forms.DialogResult.Yes Then
                    Me.Tbl_Pur_DemandDataGridView(14, e.RowIndex).Value = True
                    Me.Tbl_Pur_DemandDataGridView(15, e.RowIndex).Value = Now
                    SaveDemand()
                    ToRefresh()
    ...
    Private Sub GMNO_FillBy41()
        If txtGMNO.TextLength > 0 Then
            Try
                Me.Tbl_Pur_DemandTableAdapter.GMNODemandProcess_FillBy41(Me.DSPO.tbl_Pur_Demand, txtGMNO.Text)
            Catch ex As Exception
