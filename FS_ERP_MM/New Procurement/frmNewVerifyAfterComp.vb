Public Class frmNewVerifyAfterComp
    ...
    Private Sub frmVerifyAfterComp_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        'TODO: This line of code loads data into the 'DSNewProcurement.tbl_Bill_Demand' table. You can move, or remove it, as needed.
        'Me.Tbl_Bill_DemandTableAdapter.Fill(Me.DSNewProcurement.tbl_Bill_Demand)
    ...
    Private Sub SetButton()
        For i As Integer = 0 To Tbl_Pur_DemandDataGridView.RowCount - 1
            If Tbl_Pur_DemandDataGridView.Item(11, i).Value Is DBNull.Value Then
                Tbl_Pur_DemandDataGridView.Item(16, i).ReadOnly = True
            Else
                Tbl_Pur_DemandDataGridView.Item(16, i).ReadOnly = True
            End If
        Next
    ...
    Private Sub Demand_FillBy1()
        ...
        If Status = 1 Then
            Try
                Me.Tbl_Bill_DemandTableAdapter.FillBy45(Me.DSNewProcurement.tbl_Bill_Demand, DateTimePicker1.Value.Date, DateTimePicker2.Value.Date)
    ...
    Private Sub Demand_FillBy2()
        If Status = 1 Then
            If CodeComboBox.SelectedValue <> Nothing Then
                Me.Tbl_Bill_DemandTableAdapter.FillBy46(Me.DSNewProcurement.tbl_Bill_Demand, CodeComboBox.SelectedValue)
                SetButton()
            End If
        ElseIf Status = 4 Then
            Try
    ...
    Private Sub Demand_FillBy3()
        ...
        If Status = 1 Then
            If CodeComboBox.SelectedValue <> Nothing Then
                Me.Tbl_Bill_DemandTableAdapter.FillBy47(Me.DSNewProcurement.tbl_Bill_Demand, DateTimePicker1.Value.Date, DateTimePicker2.Value.Date, CodeComboBox.SelectedValue)
                SetButton()
            End If
        ElseIf Status = 4 Then
            If CodeComboBox.SelectedValue <> Nothing Then
    ...
    Private Sub Demand_FillBy4()
        ...
        If Status = 1 Then
            If CustNameComboBox.SelectedValue <> Nothing Then
                Try
                    Me.Tbl_Bill_DemandTableAdapter.FillBy48(Me.DSNewProcurement.tbl_Bill_Demand, CustNameComboBox.SelectedValue)
                Catch ex As Exception
    ...
    Private Sub Tbl_Pur_DemandDataGridView_CellContentClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles Tbl_Pur_DemandDataGridView.CellContentClick
        ...
        ElseIf e.ColumnIndex = 19 And e.RowIndex >= 0 Then
            Try
                If Tbl_Pur_DemandDataGridView.Item(14, e.RowIndex).Value = True Then
                    ...
                    ChildWindowOpen("frmNewPartialReceiving")
                Else
                End If
            Catch ex As Exception
        ...
        If e.ColumnIndex = 20 Then
            If Me.Tbl_Pur_DemandDataGridView.Item(20, e.RowIndex) Is DBNull.Value Then
                Me.Tbl_Pur_DemandDataGridView.Item(20, e.RowIndex).Value = True
                Me.Tbl_Pur_DemandDataGridView.Item(21, e.RowIndex).Value = Now.Date
            Else
                Try
                    If Me.Tbl_Pur_DemandDataGridView.Item(20, e.RowIndex).Value = False Then
                        Me.Tbl_Pur_DemandDataGridView.Item(20, e.RowIndex).Value = True
                        Me.Tbl_Pur_DemandDataGridView.Item(21, e.RowIndex).Value = Now.Date
                    Else
                        Me.Tbl_Pur_DemandDataGridView.Item(20, e.RowIndex).Value = False
                        Me.Tbl_Pur_DemandDataGridView.Item(21, e.RowIndex).Value = DBNull.Value
                    End If
                Catch ex As Exception
                    Me.Tbl_Pur_DemandDataGridView.Item(20, e.RowIndex).Value = True
                    Me.Tbl_Pur_DemandDataGridView.Item(21, e.RowIndex).Value = Now.Date
    ...
    Private Sub ChildWindowOpen(ByVal childWindow As String)
        For Each f As Form In frmMain.MdiChildren
            ...
            End If
        Next
        frmNewPartialReceiving.MdiParent = frmMain
        frmNewPartialReceiving.Show()
    End Sub
    Sub ToRefresh()
        If RadioButton1.Checked Then
            Demand_FillBy1()
    ...
    Private Sub GMNO_FillBy41()
        If Status = 1 Then
            If txtGMNO.TextLength > 0 Then
                Try
                    Me.Tbl_Bill_DemandTableAdapter.FillBy49(Me.DSNewProcurement.tbl_Bill_Demand, txtGMNO.Text)
                Catch ex As Exception
    ...
    Private Sub SaveToolStripButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SaveToolStripButton.Click
        Try
            Me.ValidateChildren()
            Me.Tbl_Bill_DemandBindingSource.EndEdit()
            Me.Tbl_Bill_DemandTableAdapter.Update(Me.DSNewProcurement.tbl_Bill_Demand)
